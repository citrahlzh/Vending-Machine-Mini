    ...
    <section class="space-y-6 p-2">
        <div>
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-[28px] font-semibold leading-none text-[#3C1C5E]">Ubah Data Harga</h1>
            </div>
    ...
    <script>
        (() => {
            ...
            form.addEventListener('submit', async (event) => {
                ...
                try {
                    const response = await fetch(`/api/price/update/${priceId}`, {
                        method: 'POST',
                        headers: {
                    ...
                    if (!response.ok) {
                        ...
                        const message = errors.length > 0 ? errors[0] : (data?.message || 'Gagal memperbarui harga.');
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: 'Berhasil',
                        text: data?.message || 'Data harga berhasil diperbarui.',
                        timer: 1400,

        ...
        <div
            ...
            <div
                ...
                <div id="payment-error"
                    class="mt-2 hidden rounded-[10px] bg-[#fff1f1] px-3 py-2 text-[12px] text-[#b83232]">
                </div>
...
@push('script')
    <script>
        ...
        const setFinalState = (isSuccess, message) => {
            ...
            let countdown = 5;
            if (finalMessage) {
                finalMessage.textContent = `${message} Anda akan diarahkan ke beranda dalam ${countdown} detik.`;
            }
            finalCountdownInterval = setInterval(() => {
                ...
                if (finalMessage) {
                    finalMessage.textContent =
                        `${message} Anda akan diarahkan ke beranda dalam ${countdown} detik.`;
                }
            }, 1000);
